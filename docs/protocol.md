        # Metafusion Lab: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metafusion-lab.git

        ## Objective

        MetaFusion Lab is an experimental platform for fusing heterogeneous evidence sources—trials, observational studies, registries—into coherent pooled estimates.
        ...
        - Code: https://github.com/mahmood726-cyber/metafusion-lab.git
